...
class GaussianDiffusion(nn.Module):
    ...
    def set_noise_schedule(self, schedule_opt, device):
        ...
        posterior_var =  (1. - gamma_tmin1) / (1. - gamma) * betas
    ...
    def p_mean_variance(self, x, t, clip_denoised: bool, noisy_img=None): 
        ...
        if noisy_img is not None:
            ...
            x, t=t, noise=self.diffusion_net(x, noise_level, cond_img=noisy_img))
        else:
            x_recon = self.predict_start_from_noise(
    ...
    def p_losses(self, x_in, noisy_img, noise=None):
        ...
        if not self.cond:
            ...
            x_recon = self.diffusion_net(x_noisy, continuous_sqrt_gamma, cond_img=noisy_img)
